...
@section('custom_css')
    <link rel="stylesheet" type="text/css" href="/site/styles/categories.css">
    <link rel="stylesheet" type="text/css" href="/site/styles/categories_responsive.css">
@endsection
@section('custom_js')
...
@section('content')
    <div class="home">
        <div class="home_container">
            <div class="home_background" style="background-image:url('/site/images/{{$cat->img}}')"></div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="home_content">
                                ...
                                <div class="home_text"><p>Lorem  dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie eros. Sed viverra velit venenatis fermentum luctus.</p></div>
                ...
                <div class="col">
                    <div class="product_grid">
                        ...
                        <!-- Product -->
                            ...
                            @endphp
                            <div class="product">
                                <div class="product_image"><img src="/site/images/{{$image}}" alt="{{$product->title}}"></div>
                    ...
                    {{ $products->appends(request()->query())->links('site.pagination.index') }}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row icon_box_row">
                ...
                <div class="col-lg-4 icon_box_col">
                    <div class="icon_box">
                        <div class="icon_box_image"><img src="/site/images/icon_1.svg" alt=""></div>
                ...
                <div class="col-lg-4 icon_box_col">
                    <div class="icon_box">
                        <div class="icon_box_image"><img src="/site/images/icon_2.svg" alt=""></div>
                ...
                <div class="col-lg-4 icon_box_col">
                    <div class="icon_box">
                        <div class="icon_box_image"><img src="/site/images/icon_3.svg" alt=""></div>
